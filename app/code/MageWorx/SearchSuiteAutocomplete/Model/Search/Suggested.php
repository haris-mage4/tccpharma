...
class Suggested implements \MageWorx\SearchSuiteAutocomplete\Model\SearchInterface
{
     ...
     * @param Data $customSearchHelper
     */
    public function __construct(
        HelperData $helperData,
        SearchHelper $searchHelper,
        AutocompleteInterface $autocomplete,
        Data $customSearchHelper
    ) {
        $this->helperData = $helperData;
        $this->searchHelper = $searchHelper;
        $this->autocomplete = $autocomplete;
        $this->customSearchHelper = $customSearchHelper;
    }
    ...
    public function getResponseData()
    {
        ...
        $responseData['isParamInNames'] = $this->customSearchHelper->isParamInNames();

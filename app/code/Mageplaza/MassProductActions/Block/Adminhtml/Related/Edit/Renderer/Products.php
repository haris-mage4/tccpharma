...
namespace Mageplaza\MassProductActions\Block\Adminhtml\Related\Edit\Renderer;
...
/**
 * Class Products
 * @package Mageplaza\MassProductActions\Block\Adminhtml\Related\Edit\Renderer
 */
class Products extends Extended
{
    ...
    {
        $this->setId('relatedProductsGrid');
    ...
    {
        $ids = $this->getRequest()->getPost('related_products', null);
    ...
    {
        return $this->getUrl('mpmassproductactions/product_grid/relatedProducts');
    }

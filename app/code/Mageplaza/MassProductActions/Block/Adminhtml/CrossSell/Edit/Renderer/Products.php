...
namespace Mageplaza\MassProductActions\Block\Adminhtml\CrossSell\Edit\Renderer;
...
/**
 * Class Products
 * @package Mageplaza\MassProductActions\Block\Adminhtml\CrossSell\Edit\Renderer
 */
class Products extends Extended
{
    ...
    {
        $this->setId('crossSellProductsGrid');
    ...
    {
        $ids = $this->getRequest()->getPost('cross_sell_products', null);
    ...
    {
        return $this->getUrl('mpmassproductactions/product_grid/crossSellProducts');
    }

...
namespace Mageplaza\MassProductActions\Block\Adminhtml\Image\Edit\Renderer;
...
/**
 * Class Products
 * @package Mageplaza\MassProductActions\Block\Adminhtml\Image\Edit\Renderer
 */
class Products extends Extended
{
    ...
    {
        $mediaCollection = $this->_productColFactory->create()->addStoreFilter()
            ->addMediaGalleryData();
        ...
        $productIds = [];
        /** Get product ids which has gallery images */
        foreach ($mediaCollection as $product) {
            /** @var Product $product */
    ...
    {
        $ids = $this->getRequest()->getPost('image_products', null);
    ...
    {
        return $this->getUrl('mpmassproductactions/product_grid/imageProducts');
    }

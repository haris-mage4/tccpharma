...
namespace Mageplaza\MassProductActions\Ui\DataProvider\Option\Form\Modifier;
...
class CustomOptions extends AbstractModifier
{
    ...
    {
        $options        = [];
        $productOptions = $this->getProduct()->getOptions() ?: [];
    ...
    {
        return new DataObject(['store_id' => 1, 'id' => 1]);
    }

 ...
 */
class MassUpSell extends AbstractLinkProduct
{
    /**
    ...
    public function getCurrentLinkProductSku($product)
    {
        ...
        if ($currentLinkProdCol = $product->getUpSellProductCollection()) {

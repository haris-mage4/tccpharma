...
define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            quote.shippingMethod.subscribe(function () {//this function trigger when changing shipping address (country, region, postcode)
        ...
        selectShippingMethod: function (shippingMethod) { // trigger when click on shipping method and after change shipping address
            ...
            setShippingInformationAction();//save seleted shipping method and update payment method by ajax

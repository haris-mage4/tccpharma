...
namespace Magemonkeys\RepresentativeAttr\Block\Widget;


class RepresentativeAttr extends \Magento\Customer\Block\Widget\AbstractWidget {

    /*Attribute Code is */
    const ATTRIBUTE_CODE = 'representative';
    ...
    /*public function _construct()
    {
        ...
        //$this->setTemplate('widget/customer_representative.phtml');
    }*/
   ...
   /* public function getAttributeValidationClass(){
    ...
    public function getRepresentative(){
        return $this->getCustomer()->getRepresentative();
    }

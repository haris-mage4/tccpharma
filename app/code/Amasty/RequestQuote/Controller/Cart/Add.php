...
class Add extends \Amasty\RequestQuote\Controller\Cart
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            // ];
            // $this->updateProductStock($productId, $stockData);
    ...
    public function updateProductStock($productId, $stockData)
    {
        ...
        $productStockRegistry = $objectManager->get('\Magento\CatalogInventory\Api\StockRegistryInterface');

        try {
            $product = $productRepository->getById($productId);
            $stockItem = $productStockRegistry->getStockItem($product->getId());
            ...
            if (!$stockItem->getIsInStock()) {
                ...
                $productStockRegistry->updateStockItemBySku($product->getSku(), $stockItem);
                ...
                $stockIndexer = $indexerRegistry->get(\Magento\CatalogInventory\Model\Indexer\Stock\Processor::INDEXER_ID);

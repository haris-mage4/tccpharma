    ...
    public function updateQuoteItems($items)
    {
        foreach ($items as $itemId => $info) {
            ...
            if (isset($info['available_qty'])) {
                $info['available_qty'] = (float)$info['available_qty'];
            }

            if (isset($info['quote_note'])) {
                $info['quote_note'] = $info['quote_note'];
            }

            if (isset($info['requested_price'])) {
                $info['requested_price'] = $info['requested_price'];
            }

            if (isset($info['email_subject'])) {
                $info['email_subject'] = $info['email_subject'];
            }
            ...
            if (isset($info['requested_qty'])) {
                $info['requested_qty'] = $info['requested_qty'];
            }

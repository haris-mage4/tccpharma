...
return [
    'modules' => [
        ...
        'Amasty_QuoteAttributesManagement' => 1,
        'Amasty_RequestAQuoteProSubscriptionPackage' => 1,
        'Amasty_QuoteAttributes' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Baldwin_UrlDataIntegrityChecker' => 0,
        'Bss_Core' => 0,
        'Bss_Reindex' => 0,
        ...
        'Eagle_Common' => 1,
        'Eagle_CustomSearchBlock' => 1,
        'Eagle_DisableQtyValidation' => 1,
        'Eagle_ImageResize' => 1,
        'Eagle_Sorting' => 1,
        'Eagle_Tooltip' => 1,
        'Eaglerocket_Customquote' => 0,
        'Fc_CustomHandles' => 1,
        ...
        'Magemonkeys_CategoryFilter' => 1,
        'Magemonkeys_CompanyName' => 1,
        'Magemonkeys_Customerinfo' => 1,
        'Magemonkeys_FeaturedProduct' => 1,
        'Magemonkeys_HideMyOrders' => 1,
        'Magemonkeys_Ordermail' => 1,
        'Magemonkeys_Product' => 1,
        'Magemonkeys_Quote' => 1,
        'Magemonkeys_RemoveQuoteCartPrice' => 1,
        'Magemonkeys_RepresentativeAttr' => 1,
        'Magemonkeys_RestrictCategory' => 1,
        'Magemonkeys_WelcomeEmailCc' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_BannerSlider' => 1,
        'Mageplaza_BackendReindex' => 1,
        'Mageplaza_MassProductActions' => 1,
        'Mageplaza_Smtp' => 1,
        'Magestat_SplitOrder' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'RapideWeb_ProductListTable' => 1,
        ...
        'Stathmos_Customize' => 1,
        'Stathmos_ExtendedOrdersGrid' => 1,
        'Stathmos_QuoteCommunication' => 1,
        'TCCPharma_CatalogUrlRewrite' => 1,
